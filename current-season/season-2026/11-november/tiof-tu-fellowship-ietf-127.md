...
Check the [Timeline](tiof-tu-fellowship-ietf-127.md#timeline) below for more details.
{% endhint %}
...
* **Two preparation sessions (see** [#timeline](tiof-tu-fellowship-ietf-127.md#timeline "mention")**)**
...
- Preparation Sessions (see [Timeline](tiof-tu-fellowship-ietf-127.md#timeline))
- [\[IETF\] IETF 126](../07-july/ietf-ietf-126.md)
...
* [x] Submit your Fellowship Report before the deadline (see [Timeline](tiof-tu-fellowship-ietf-127.md#timeline)).
{% endcolumn %}
...
* [x] Fellowship mentoring, including Preparation Sessions and during sessions (See [#timeline](tiof-tu-fellowship-ietf-127.md#timeline "mention")and IETF Agenda)\
...
Submit your interest! Make sure to read the [Requirements](tiof-tu-fellowship-ietf-127.md#requirements) and understand the [Responsibilities](tiof-tu-fellowship-ietf-127.md#responsibilities).\
...
Fellows who have successfully completed the [Fellowship Requirements](tiof-tu-fellowship-ietf-127.md#requirements) will receive a digital certificate as a proof of completion.
{% endstep %}
{% endstepper %}
