...
# \[#TIOF] Internship Cohort Q1 2026
...
The IO Foundation, is seeking passionate and dedicated individuals to join our internship cohort for its Q1 2026 intake (1st January 2026 - 31th  March 2026) for both in-person and remote modalities.

{% hint style="success" %}
## NOTICE

While our intake dates are set, the actual duration of your internship can be tailored to meet your specific university requirements.
{% endhint %}

At TIOF, our interns join a global community of advocates and technical experts.

Interns collaborate by:

* [x] supporting the organization's daily operations
* [x] planning and executing activities
* [x] planning and executing projects
...
The cohort application will be closed when the quota is reached. Apply soon!!
{% endhint %}

{% hint style="info" %}
## WHO CAN JOIN?

Full-Time Bachelor Student from various backgrounds\
See the [#internship-details](tiof-internship-cohort-q1-2026.md#internship-details "mention")
{% endhint %}
...
An internship in The IO Foundation is an opportunity to grow your career with a real environment combining advocacy and production. You will be mentored by experienced members of the organization and provided with all the tools you will need to carry out your duties during your internship.

For more information, make sure to check the [Terms of Reference](tiof-internship-cohort-q1-2026.md#terms-of-reference) ([Benefits](tiof-internship-cohort-q1-2026.md#benefits) + [Responsibilities](tiof-internship-cohort-q1-2026.md#responsibilities)).

## Internship Details

The following are the open positions for this Internship Cohort:

<table><thead><tr><th valign="top">TIOF Team</th><th valign="top">Role</th><th width="110" valign="top">Quantity</th><th valign="top">Background</th></tr></thead><tbody><tr><td valign="top">Infrastructure</td><td valign="top"><ul><li>Networking</li><li>Automation</li><li>Virtualization</li><li>LLM development</li><li>Other infrastructure attributions</li></ul></td><td valign="top">4</td><td valign="top"><ul><li>Computer Science and Technology</li><li>Software Engineering</li><li>Cyber Security</li><li>Artificial Intelligence</li></ul></td></tr><tr><td valign="top">Resource Allocation and Mobilization</td><td valign="top"><ul><li>Business Plan Development</li><li>Sales Strategy Development</li></ul></td><td valign="top">2</td><td valign="top"><ul><li>E-Commerce</li><li>International Business</li></ul></td></tr><tr><td valign="top">Communications</td><td valign="top"><ul><li>Digital Producer</li><li>Campaigns design and execution</li><li>Community content development and execution</li></ul></td><td valign="top">2</td><td valign="top"><ul><li>Communications or Media Studies</li><li>Digital Media Technology</li><li>Advertising</li></ul></td></tr><tr><td valign="top">Human Resources</td><td valign="top"><ul><li>Community Management</li></ul></td><td valign="top">1</td><td valign="top"><ul><li>Communications or Media Studies</li></ul></td></tr><tr><td valign="top">Finance</td><td valign="top"><ul><li>Finance assistant</li></ul></td><td valign="top">1</td><td valign="top"><ul><li>Accounting</li></ul></td></tr></tbody></table>

## Modalities

<table data-card-size="large" data-view="cards"><thead><tr><th></th></tr></thead><tbody><tr><td>In-Person</td></tr><tr><td>Online</td></tr></tbody></table>
...
- In-person (for those who stay or plan to stay in Kuala Lumpur during the internship)
- Remote (for those who stay in any other part of the globe)

* [x] In-person interns will perform their duties at TIOF's HQ, unless otherwise specified.
* [x] Remote interns will perform their duties at their corresponding Argos Club, unless otherwise specified.
...
* [x] Actively participate in TIOF's operations, projects and activities.
* [x] Fulfill the duration and working hours of the internship, which will be agreed between TIOF and the intern, on the basis of the respective university's requirements.

{% hint style="success" %}
## NOTICE

The IO Foundation will give a final score based to Intern performance and will produced certificate when the Terms of Reference are fulfilled by both parties.
{% endhint %}
{% endcolumn %}
...
* [x] Execute, diligently, the assigned tasks.
* [x] Actively participate in the corresponding Work Meetings and check-ins as needed.
* [x] Provide all administrative documents that are required by both TIOF and the respective university, as and when requested.
* [x] Collaborate with other TIOF Members to enhance the impact of the organization's advocacy effort.s.
...
{% columns %}
{% column %}
* [x] Provide first hand experience in all TIOF activities within the DCDR framework, which will include, but not limited to:
...
The following items are covered for In-Person and Remote internships:

<table><thead><tr><th width="181" valign="top">ITEM</th><th width="121">COVERED<select><option value="hE9nSvbws5DY" label="Yes" color="blue"></option><option value="YdnQRDyLePqW" label="No" color="blue"></option><option value="dIrPcDKdU7qO" label="Partially" color="blue"></option><option value="ETybMsBQmBur" label="Not Applicable" color="blue"></option><option value="92I4vhzEL4b9" label="As applicable" color="blue"></option><option value="JuARprnN38Mt" label="See Notes" color="blue"></option></select></th><th>NOTES</th></tr></thead><tbody><tr><td valign="top">Transportation</td><td><span data-option="YdnQRDyLePqW">No</span></td><td>Interns will have to arrange for their transportation back and forth to their corresponding internship location.</td></tr><tr><td valign="top">Accommodation</td><td><span data-option="YdnQRDyLePqW">No</span></td><td>Interns will have to arrange for their accommodation.</td></tr><tr><td valign="top">F&#x26;B</td><td><span data-option="92I4vhzEL4b9">As applicable</span></td><td>Interns will benefit of F&#x26;B as applicable, such as being available for a given activity.</td></tr><tr><td valign="top">Per diem</td><td><span data-option="hE9nSvbws5DY">Yes</span></td><td><p>This Internship includes per diem.</p><ul class="contains-task-list"><li><input type="checkbox">Malaysia: RM 600 / month</li><li><input type="checkbox">Indonesia: IDR 2.500.000 / month</li></ul></td></tr><tr><td valign="top">Visa</td><td><span data-option="YdnQRDyLePqW">No</span></td><td>This internship <strong>may</strong> involve any visas depending on your passport. TIOF will help with any supporting documents needed to apply for your visa yet won't cover its cost.</td></tr><tr><td valign="top">Others</td><td><span data-option="JuARprnN38Mt">See Notes</span></td><td>This list may be updated as necessary.</td></tr></tbody></table>

{% hint style="warning" %}
## LIMITED SPOTS, APPLY WITHIN THE PERIOD
...
<table data-view="cards"><thead><tr><th></th><th></th><th data-hidden data-card-cover data-type="image">Cover image</th></tr></thead><tbody><tr><td>Would you like to partner with us in our internships?</td><td><a href="mailto:Contact@TheIOFoundation.org">Reach out!</a></td><td><a href="../../../.gitbook/assets/[TIOF] Comms [P] 0000-00-00 TIOF Card Partners CTA XXX v1.0.png">[TIOF] Comms [P] 0000-00-00 TIOF Card Partners CTA XXX v1.0.png</a></td></tr></tbody></table>
{% endcolumn %}
{% endcolumns %}
...
Help spreading the word about this Internship opportunity.

Here's a suggested text:

{% code overflow="wrap" %}
```
⚡ Check out this #Internship opportunity from @TheIOFoundation!
...
Media taken during the internship will be posted here.
