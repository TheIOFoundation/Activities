...
* Role: The "Internet Stack" is a layered architecture where different bodies (IETF, W3C, IEEE) manage different functions
...
* Role: The engine rooms of the IETF. These are specialized groups where experts collaborate on specific topics
* Relevance to the Fellowship: You will learn how to identify, monitor, and engage with these groups.&#x20;
